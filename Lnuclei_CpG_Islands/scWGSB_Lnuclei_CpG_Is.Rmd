---
title: "scWGBS - Lnuclei CpG Islands"
...
- 239 non-redundant regions used for clustering by Epiclomal 
...
```{r}
data_mean_region = read.csv("final_mean_meth_region_Lnuclei_CpGIs.tsv", sep = "\t")
data_cpg_sites = read.csv("input_Epiclomal_Lnuclei.tsv", sep = "\t")
cluster_region = read.csv("cluster_posteriors_bestrun_region_Lnuclei.tsv", sep = "\t")
cells = read.csv("Liver_nuclei_all_210306.csv", sep = ";")
```
...
#saveRDS(tsne_region, "tsne_region_Lnuclei.rds")

tsne_region = readRDS("tsne_region_Lnuclei.rds")
```
...
tsne_plot_region[tsne_plot_region$pool %in% c("pool76", "pool77", "pool78", "pool79", "pool80", "pool81"),]$Batch = "2"
tsne_plot_region[tsne_plot_region$pool %in% c("pool82", "pool83", "pool84", "pool85", "pool86", "pool87"),]$Batch = "3"

---
title: "scWGBS - Lnuclei GENE BODIES"
...
- 793 non-redundant regions used for clustering by Epiclomal 
...
```{r}
data_mean_region = read.csv("final_mean_meth_region_Lnuclei_GB.tsv", sep = "\t")
data_cpg_sites = read.csv("input_Epiclomal_Lnuclei_GB.tsv", sep = "\t")
cluster_region = read.csv("cluster_posteriors_bestrun_region_Lnuclei.tsv", sep = "\t")
keep_regions = read.csv("filtered_regions_Lnuclei_GB.tsv", header = F)
```
...
#saveRDS(tsne_region, "tsne_region_Lnuclei_GB.rds")

tsne_region = readRDS("tsne_region_Lnuclei_GB.rds")
```
...
#saveRDS(tsne_basic, "tsne_basic_Lnuclei_GB.rds")

tsne_basic = readRDS("tsne_basic_Lnuclei_GB.rds")
```
